//this sends the value provided by the generator and puts it into the email field 
$(document).ready(function() {
    $("#mailme").click(function() {
        $("#textarea").val($("#positive").val())
    });

});


//positive words generator on the web page
function process() {
    var textfield = document.getElementById('positive'); // this is the place where the words will show
    textfield.value = generator(); // the value(aka positive words ) are coming from the generator function
    $("#textarea").val($("#positive").val()); // the value from the pwg will then go to textarea
}

//looping through the arrays of words
...
function generator() {
    ...
    // here i say how it is returned and in what order
